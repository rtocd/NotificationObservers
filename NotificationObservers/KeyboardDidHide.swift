...
public struct KeyboardDidHide: NotificationType {
    ...
    public static func makeObserver() -> NotificationObserver<KeyboardDidHide> {
        return NotificationObserver<KeyboardDidHide>()
    }
...
extension KeyboardDidHide: CustomDebugStringConvertible {
    public var debugDescription: String {
        return "KeyboardDidHide: [animationDuration: \(String(describing: self.animationDuration)), isLocal: \(self.isLocal), endFrame: \(self.endFrame), animationCurve: \(self.animationCurve), startFrame: \(self.startFrame)]"
    }
}
