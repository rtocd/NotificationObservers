...
public struct KeyboardWillShow: NotificationType {
    ...
    public static func makeObserver() -> NotificationObserver<KeyboardWillShow> {
        return NotificationObserver<KeyboardWillShow>()
    }
...
extension KeyboardWillShow: CustomDebugStringConvertible {
    public var debugDescription: String {
        return "KeyboardWillShow: [animationDuration: \(String(describing: self.animationDuration)), isLocal: \(self.isLocal), endFrame: \(self.endFrame), animationCurve: \(self.animationCurve), startFrame: \(self.startFrame)]"
    }
}
